            ...
            <nav className="px-2 sm:px-4 py-2.5 fixed w-full top-0 z-10 left-0 bg-black">
                <div className="container flex flex-wrap items-center justify-between mx-auto">
                    ...
                    <div className="flex md:order-2">
                        ...
                        <Link to="/signin"><button type="button" className="text-white hidden md:flex bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 mb-2">Sign In</button></Link>
                        <Link to="/join"><button type="button" className="text-white hidden md:flex font-medium bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800  text-lg rounded-lg px-5 py-2.5 text-center mr-2 mb-2">Sign Up</button></Link>
                        <button
                            type="button"
                    ...
                    >
                        <ul className={stylenavbarlistitems}>
                            ...
                            <Link to="/signin"><button type="button" className={stylenavbarlistbutton}>Sign In</button></Link>
