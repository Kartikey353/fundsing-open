            ...
            >
                <div className="text-center upperpart">
                    ...
                    <div className="buttons mt-5">
                        <Link to="/join/startup"><button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300  rounded-lg text-lg md:text-xl px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 font-bold">Join <span className='text-gray-400 text-lg'>to raise funds</span></button></Link>
                        <Link to="/join/investor"> <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300  rounded-lg text-lg md:text-xl px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 font-bold">Join <span className='text-gray-400 text-lg'>to invest</span></button></Link>
                    </div>
                </div>
